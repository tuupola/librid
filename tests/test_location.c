...
TEST test_set_and_get_track_direction(void) {
    ...
    for (uint16_t degrees = 0; degrees <= RID_TRACK_DIRECTION_MAX; degrees++) {
        ...
        int status = rid_location_set_track_direction(&location, degrees);
        ASSERT_EQ(RID_SUCCESS, status);

        uint16_t result = rid_location_get_track_direction(&location);
...
TEST test_track_direction_unknown(void) {
    ...
    int status = rid_location_set_track_direction(&location, RID_TRACK_DIRECTION_UNKNOWN);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_track_direction_out_of_range(void) {
    ...
    int status = rid_location_set_track_direction(&location, 360);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);

    /* Test degrees > 361 */
    status = rid_location_set_track_direction(&location, 500);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_track_direction_null_pointer(void) {
    ASSERT_EQ(RID_TRACK_DIRECTION_UNKNOWN, rid_location_get_track_direction(NULL));
...
TEST test_set_and_get_speed_slow(void) {
    ...
    for (size_t i = 0; i < sizeof(test_speeds) / sizeof(test_speeds[0]); i++) {
        ...
        int status = rid_location_set_speed(&location, test_speeds[i]);
        ASSERT_EQ(RID_SUCCESS, status);

        ASSERT_EQ(0, location.speed_multiplier);

        float result = rid_location_get_speed(&location);
...
TEST test_speed_boundary_transition(void) {
    ...
    int status = rid_location_set_speed(&location, 63.75f);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.speed_multiplier);
    /* 255 * 0.25 = 63.75 */
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_speed(&location, 64.0f);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(1, location.speed_multiplier);
...
TEST test_maximum_speed(void) {
    ...
    int status = rid_location_set_speed(&location, 300.0f);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(1, location.speed_multiplier);
...
TEST test_negative_speed(void) {
    ...
    int status = rid_location_set_speed(&location, -10.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_invalid_speed(void) {
    ...
    int status = rid_location_set_speed(&location, RID_SPEED_INVALID);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(255, location.speed);
    ASSERT_EQ(1, location.speed_multiplier);
...
TEST test_get_speed_null_pointer(void) {
    ASSERT_EQ(RID_SPEED_INVALID, rid_location_get_speed(NULL));
...
TEST test_set_and_get_vertical_speed(void) {
    ...
    for (size_t i = 0; i < sizeof(test_speeds) / sizeof(test_speeds[0]); i++) {
        ...
        int status = rid_location_set_vertical_speed(&location, test_speeds[i]);
        ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_vertical_speed_invalid(void) {
    ...
    /* Test invalid or unknown speed */
    int status = rid_location_set_vertical_speed(&location, RID_VERTICAL_SPEED_INVALID);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_get_vertical_speed_null_pointer(void) {
    ASSERT_EQ(RID_VERTICAL_SPEED_INVALID, rid_location_get_vertical_speed(NULL));
...
TEST test_set_and_get_height(void) {
    ...
    for (size_t i = 0; i < sizeof(test_heights) / sizeof(test_heights[0]); i++) {
        ...
        int status = rid_location_set_height(&location, test_heights[i]);
        ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_height_out_of_range(void) {
    ...
    /* Test > 31767 meters */
    int status = rid_location_set_height(&location, 32000.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);

    /* Test < -1000 meters */
    status = rid_location_set_height(&location, -1001.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_height_invalid(void) {
    ...
    int status = rid_location_set_height(&location, RID_HEIGHT_INVALID);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_get_height_null_pointer(void) {
    ASSERT_EQ(RID_HEIGHT_INVALID, rid_location_get_height(NULL));
...
TEST test_set_and_get_pressure_altitude(void) {
    ...
    for (size_t i = 0; i < sizeof(test_altitudes) / sizeof(test_altitudes[0]); i++) {
        ...
        int status = rid_location_set_pressure_altitude(&location, test_altitudes[i]);
        ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_pressure_altitude_out_of_range(void) {
    ...
    /* Test > 31767 meters */
    int status = rid_location_set_pressure_altitude(&location, 32000.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);

    /* Test < -1000 meters */
    status = rid_location_set_pressure_altitude(&location, -1001.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_pressure_altitude_invalid(void) {
    ...
    int status = rid_location_set_pressure_altitude(&location, RID_PRESSURE_ALTITUDE_INVALID);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_get_pressure_altitude_null_pointer(void) {
    ASSERT_EQ(RID_PRESSURE_ALTITUDE_INVALID, rid_location_get_pressure_altitude(NULL));
...
TEST test_set_and_get_geodetic_altitude(void) {
    ...
    for (size_t i = 0; i < sizeof(test_altitudes) / sizeof(test_altitudes[0]); i++) {
        ...
        int status = rid_location_set_geodetic_altitude(&location, test_altitudes[i]);
        ASSERT_EQ(RID_SUCCESS, status);

        float result = rid_location_get_geodetic_altitude(&location);
...
TEST test_geodetic_altitude_out_of_range(void) {
    ...
    /* Test below minimum */
    int status = rid_location_set_geodetic_altitude(&location, -1001.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);

    /* Test above maximum */
    status = rid_location_set_geodetic_altitude(&location, 31768.0f);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_geodetic_altitude_invalid(void) {
    ...
    /* Test invalid or unknown altitude */
    int status = rid_location_set_geodetic_altitude(&location, RID_GEODETIC_ALTITUDE_INVALID);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(RID_GEODETIC_ALTITUDE_INVALID_ENCODED, location.geodetic_altitude);

    /* Should decode back to RID_GEODETIC_ALTITUDE_INVALID */
    float result = rid_location_get_geodetic_altitude(&location);
    ASSERT_EQ(RID_GEODETIC_ALTITUDE_INVALID, result);
...
TEST test_get_geodetic_altitude_null_pointer(void) {
    ASSERT_EQ(RID_GEODETIC_ALTITUDE_INVALID, rid_location_get_geodetic_altitude(NULL));
...
TEST test_set_and_get_height_type(void) {
    ...
    int status = rid_location_set_height_type(&location, RID_HEIGHT_TYPE_ABOVE_TAKEOFF);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.height_type);

    rid_height_type_t result = rid_location_get_height_type(&location);
    ASSERT_EQ(RID_HEIGHT_TYPE_ABOVE_TAKEOFF, result);

    /* Test RID_HEIGHT_TYPE_AGL */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_height_type(&location, RID_HEIGHT_TYPE_AGL);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(1, location.height_type);

    result = rid_location_get_height_type(&location);
...
TEST test_height_type_out_of_range(void) {
    ...
    int status = rid_location_set_height_type(&location, (rid_height_type_t)2);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_height_type_null_pointer(void) {
    ASSERT_EQ(RID_HEIGHT_TYPE_ABOVE_TAKEOFF, rid_location_get_height_type(NULL));
...
TEST test_set_and_gte_operational_status(void) {
    ...
    int status = rid_location_set_operational_status(&location, RID_OPERATIONAL_STATUS_UNDECLARED);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.operational_status);

    rid_operational_status_t result = rid_location_get_operational_status(&location);
    ASSERT_EQ(RID_OPERATIONAL_STATUS_UNDECLARED, result);

    /* Test RID_OPERATIONAL_STATUS_GROUND */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_operational_status(&location, RID_OPERATIONAL_STATUS_GROUND);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_operational_status(&location, RID_OPERATIONAL_STATUS_AIRBORNE);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_operational_status(&location, RID_OPERATIONAL_STATUS_EMERGENCY);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_operational_status(&location, RID_OPERATIONAL_STATUS_REMOTE_ID_SYSTEM_FAILURE);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_operational_status_out_of_range(void) {
    ...
    /* Test value > 15 */
    int status = rid_location_set_operational_status(&location, (rid_operational_status_t)16);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_operational_status_null_pointer(void) {
    ASSERT_EQ(RID_OPERATIONAL_STATUS_UNDECLARED, rid_location_get_operational_status(NULL));
...
TEST test_set_and_get_speed_accuracy(void) {
    ...
    int status = rid_location_set_speed_accuracy(&location, RID_SPEED_ACCURACY_UNKNOWN);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.speed_accuracy);

    rid_speed_accuracy_t result = rid_location_get_speed_accuracy(&location);
    ASSERT_EQ(RID_SPEED_ACCURACY_UNKNOWN, result);

    /* Test RID_SPEED_ACCURACY_10MS */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_speed_accuracy(&location, RID_SPEED_ACCURACY_10MS);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_speed_accuracy(&location, RID_SPEED_ACCURACY_3MS);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_speed_accuracy(&location, RID_SPEED_ACCURACY_1MS);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_speed_accuracy(&location, RID_SPEED_ACCURACY_03MS);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_speed_accuracy_out_of_range(void) {
    ...
    /* Test value > 15 */
    int status = rid_location_set_speed_accuracy(&location, (rid_speed_accuracy_t)16);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_speed_accuracy_null_pointer(void) {
    ASSERT_EQ(RID_SPEED_ACCURACY_UNKNOWN, rid_location_get_speed_accuracy(NULL));
...
TEST test_set_and_get_horizontal_accuracy(void) {
    ...
    int status = rid_location_set_horizontal_accuracy(&location, RID_HORIZONTAL_ACCURACY_UNKNOWN);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.horizontal_accuracy);

    rid_horizontal_accuracy_t result = rid_location_get_horizontal_accuracy(&location);
    ASSERT_EQ(RID_HORIZONTAL_ACCURACY_UNKNOWN, result);

    /* Test RID_HORIZONTAL_ACCURACY_18520M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_horizontal_accuracy(&location, RID_HORIZONTAL_ACCURACY_18520M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_horizontal_accuracy(&location, RID_HORIZONTAL_ACCURACY_3704M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_horizontal_accuracy(&location, RID_HORIZONTAL_ACCURACY_30M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_horizontal_accuracy(&location, RID_HORIZONTAL_ACCURACY_1M);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_horizontal_accuracy_out_of_range(void) {
    ...
    /* Test value > 15 */
    int status = rid_location_set_horizontal_accuracy(&location, (rid_horizontal_accuracy_t)16);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_horizontal_accuracy_null_pointer(void) {
    ASSERT_EQ(RID_HORIZONTAL_ACCURACY_UNKNOWN, rid_location_get_horizontal_accuracy(NULL));
...
TEST test_set_and_get_vertical_accuracy(void) {
    ...
    int status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_UNKNOWN);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.vertical_accuracy);

    rid_vertical_accuracy_t result = rid_location_get_vertical_accuracy(&location);
    ASSERT_EQ(RID_VERTICAL_ACCURACY_UNKNOWN, result);

    /* Test RID_VERTICAL_ACCURACY_150M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_150M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_45M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_25M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_10M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_3M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_vertical_accuracy(&location, RID_VERTICAL_ACCURACY_1M);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_vertical_accuracy_out_of_range(void) {
    ...
    /* Test value > 15 */
    int status = rid_location_set_vertical_accuracy(&location, (rid_vertical_accuracy_t)16);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_vertical_accuracy_null_pointer(void) {
    ASSERT_EQ(RID_VERTICAL_ACCURACY_UNKNOWN, rid_location_get_vertical_accuracy(NULL));
...
TEST test_set_and_get_baro_altitude_accuracy(void) {
    ...
    /* Test RID_VERTICAL_ACCURACY_UNKNOWN */
    int status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_UNKNOWN);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.baro_altitude_accuracy);

    rid_vertical_accuracy_t result = rid_location_get_baro_altitude_accuracy(&location);
    ASSERT_EQ(RID_VERTICAL_ACCURACY_UNKNOWN, result);

    /* Test RID_VERTICAL_ACCURACY_150M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_150M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    /* Test RID_VERTICAL_ACCURACY_45M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_45M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    /* Test RID_VERTICAL_ACCURACY_25M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_25M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    /* Test RID_VERTICAL_ACCURACY_10M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_10M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    /* Test RID_VERTICAL_ACCURACY_3M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_3M);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    /* Test RID_VERTICAL_ACCURACY_1M */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_baro_altitude_accuracy(&location, RID_VERTICAL_ACCURACY_1M);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_baro_altitude_accuracy_out_of_range(void) {
    ...
    /* Test value > 15 */
    int status = rid_location_set_baro_altitude_accuracy(&location, (rid_vertical_accuracy_t)16);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_baro_altitude_accuracy_null_pointer(void) {
    ASSERT_EQ(RID_VERTICAL_ACCURACY_UNKNOWN, rid_location_get_baro_altitude_accuracy(NULL));
...
TEST test_set_and_get_timestamp(void) {
    ...
    for (size_t i = 0; i < sizeof(test_timestamps) / sizeof(test_timestamps[0]); i++) {
        ...
        int status = rid_location_set_timestamp(&location, test_timestamps[i]);
        ASSERT_EQ(RID_SUCCESS, status);

        uint16_t result = rid_location_get_timestamp(&location);
...
TEST test_timestamp_invalid(void) {
    ...
    int status = rid_location_set_timestamp(&location, RID_TIMESTAMP_INVALID);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_timestamp_out_of_range(void) {
    ...
    /* Test value > 36000 */
    int status = rid_location_set_timestamp(&location, 36001);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);

    status = rid_location_set_timestamp(&location, 50000);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_timestamp_null_pointer(void) {
    ASSERT_EQ(RID_TIMESTAMP_INVALID, rid_location_get_timestamp(NULL));
...
TEST test_set_and_get_timestamp_accuracy(void) {
    ...
    int status = rid_location_set_timestamp_accuracy(&location, RID_TIMESTAMP_ACCURACY_UNKNOWN);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(0, location.timestamp_accuracy);

    rid_timestamp_accuracy_t result = rid_location_get_timestamp_accuracy(&location);
    ASSERT_EQ(RID_TIMESTAMP_ACCURACY_UNKNOWN, result);

    /* Test RID_TIMESTAMP_ACCURACY_0_1S */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_timestamp_accuracy(&location, RID_TIMESTAMP_ACCURACY_0_1S);
    ASSERT_EQ(RID_SUCCESS, status);
    ASSERT_EQ(1, location.timestamp_accuracy);

    result = rid_location_get_timestamp_accuracy(&location);
    ASSERT_EQ(RID_TIMESTAMP_ACCURACY_0_1S, result);

    /* Test RID_TIMESTAMP_ACCURACY_0_5S */
    memset(&location, 0, sizeof(location));
    status = rid_location_set_timestamp_accuracy(&location, RID_TIMESTAMP_ACCURACY_0_5S);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_timestamp_accuracy(&location, RID_TIMESTAMP_ACCURACY_1_0S);
    ASSERT_EQ(RID_SUCCESS, status);
    ...
    memset(&location, 0, sizeof(location));
    status = rid_location_set_timestamp_accuracy(&location, RID_TIMESTAMP_ACCURACY_1_5S);
    ASSERT_EQ(RID_SUCCESS, status);
...
TEST test_timestamp_accuracy_out_of_range(void) {
    ...
    /* Test value > 15 */
    int status = rid_location_set_timestamp_accuracy(&location, (rid_timestamp_accuracy_t)16);
    ASSERT_EQ(RID_ERROR_OUT_OF_RANGE, status);
...
TEST test_get_timestamp_accuracy_null_pointer(void) {
    ASSERT_EQ(RID_TIMESTAMP_ACCURACY_UNKNOWN, rid_location_get_timestamp_accuracy(NULL));
...
TEST test_location_init(void) {
    ...
    uint16_t track = rid_location_get_track_direction(&location);
    ...
    ASSERT_EQ(RID_PRESSURE_ALTITUDE_INVALID, pressure_altitude);
    ASSERT_EQ(RID_GEODETIC_ALTITUDE_INVALID, geodetic_altitude);
...
TEST test_location_to_json_invalid_as_null(void) {
    rid_location_t location;
    char buffer[1024];
...
SUITE(location_suite) {
    ...
    RUN_TEST(test_get_track_direction_null_pointer);
    ...
    RUN_TEST(test_get_speed_null_pointer);
    ...
    RUN_TEST(test_get_pressure_altitude_null_pointer);
    ...
    RUN_TEST(test_get_geodetic_altitude_null_pointer);
    ...
    RUN_TEST(test_get_operational_status_null_pointer);
    ...
    RUN_TEST(test_get_speed_accuracy_null_pointer);
    ...
    RUN_TEST(test_get_horizontal_accuracy_null_pointer);
    ...
    RUN_TEST(test_get_vertical_accuracy_null_pointer);
    ...
    RUN_TEST(test_get_baro_altitude_accuracy_null_pointer);
    ...
    RUN_TEST(test_get_timestamp_null_pointer);
    ...
    RUN_TEST(test_get_timestamp_accuracy_null_pointer);
